...
class PasswordResetNotification extends Notification
{
    ...
    protected function resetUrl($notifiable)
    {
        ...
        $token = $this->token;
        $hash = encrypt($notifiable->getEmailForPasswordReset());
        $base_password_reset_link = config('external.password_reset_link');

        return $base_password_reset_link . "/" . $token . "/" . $hash;
    }
